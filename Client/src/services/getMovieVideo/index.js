...
export default async function getMovieVideo({ id }) { 
    const apiURL = 
    `https://api.themoviedb.org/3/movie/${id}/videos?api_key=${api_key}&language=es-ES`
    const apiURLEN = 
    `https://api.themoviedb.org/3/movie/${id}/videos?api_key=${api_key}&language=en-EN`
